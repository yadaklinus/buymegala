...
import { Mail, User, DollarSign, Gift, Settings as SettingsIcon, Home, BarChart2, LogIn, UserPlus, LogOut, Info } from 'lucide-react';
...
export default function App() {
    ...
    const renderPage = () => {
        // Protected routes
        if (['dashboard', 'settings', 'profile'].includes(currentPage) && !isAuthenticated) {
